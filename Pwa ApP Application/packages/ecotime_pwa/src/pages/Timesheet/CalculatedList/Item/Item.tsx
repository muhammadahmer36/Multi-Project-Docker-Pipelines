...
import { timesheetWeekly } from 'appConstants';
import { getSelectedTab } from 'pages/Timesheet/selectors';
import { useDispatch, useSelector } from 'react-redux';
import React from 'react';
import { setGroupTitle } from 'pages/TimesheetWeekly/slice';
...
export default function Item(props: Props) {
  ...
  const onPayPeriodPress = () => {
    dispatch(setGroupTitle(groupTitle));
    navigate(timesheetWeekly, { state: { selectedTab } });
  };
